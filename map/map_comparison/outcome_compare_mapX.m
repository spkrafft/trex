function [out,ccc,spear] = outcome_compare_mapX(project_path,module,feature,patient_mrn,outcome,varargin)
...
out.perdiff = (out.true - out.false)./out.false*100;
