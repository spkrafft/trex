function [map] = laws2D_map(varargin) 
...
%
%   LAWS2DS = LAWS2D_MAP(I,X,Y,Z)
%   
%   Parameters include:
%
%   Example
%   -------
%   [map] = laws2D_map(I,X,Y,Z)
% 
%   Class Support
%   -------------             
...
for count = 1:num_points
    ...
    tempstats = [];
    stats = laws2D_features(par_si{count});      
    for count_stats = 1:numel(names_stats)
...
I = double(I);
if ndims(I) > 3
  error(message('images:laws2D_map:invalidSizeForI'))
end   
